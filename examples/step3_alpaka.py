...
# with command line options: step3 -s RAW2DIGI:RawToDigi_pixelOnly,RECO:reconstruction_pixelTrackingOnly,VALIDATION:@pixelTrackingOnlyValidation,DQM:@pixelTrackingOnlyDQM --conditions 140X_mcRun3_2023_realistic_HI_v3 --datatier GEN-SIM-RECO,MINIAODSIM,NANOAODSIM,DQMIO -n 10 --eventcontent RECOSIM,MINIAODSIM,NANOEDMAODSIM,DQM --geometry DB:Extended --era Run3_pp_on_PbPb --procModifiers alpaka --fileou file:step3.root --filein file:hi_pyquen_dijet_pu_140X_mcRun3_2023_realistic_HI_v3.root
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run3_pp_on_PbPb_cff import Run3_pp_on_PbPb
from Configuration.ProcessModifiers.alpaka_cff import alpaka

process = cms.Process('RECO',Run3_pp_on_PbPb,alpaka)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/relval/CMSSW_14_1_0_pre5/RelValTTbar_14TeV/GEN-SIM-DIGI-RAW/PU_140X_mcRun4_realistic_v4_STD_2026D110_PU-v2/2580000/75afc9a7-841b-4ad8-89a8-dadbbad0602b.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, '140X_mcRun3_2023_realistic_HI_v3', '')
